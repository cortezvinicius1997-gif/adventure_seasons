...
public class SeasonLength implements Serializable {
    ...
    public Summer getSummer() { return summer; }
    public void setSummer(Summer summer) { this.summer = summer; }
    public Autumn getAutumn() { return autumn; }
    public void setAutumn(Autumn autumn) { this.autumn = autumn; }
    public Winter getWinter() { return winter; }
    public void setWinter(Winter winter) { this.winter = winter; }
}
